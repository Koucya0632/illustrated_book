...
const publisher = readFileSync(new URL("../scripts/publish-drugstore-series.ts", import.meta.url), "utf8");
const preparer = readFileSync(new URL("../scripts/prepare-drugstore-publish-plan.mjs", import.meta.url), "utf8");

test("drugstore publisher defaults to a SELECT-only preflight and requires both target confirmations", () => {
