  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-10">
      <header>
        ...
        <p className="text-sm text-muted mt-1">過去 30 天的全站行為摘要。</p>
      </header>

      <section className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <Stat label="總事件 (30d)" value={totalEvents.toLocaleString()} emoji="📡" />
        <Stat
          label="不同訪客 (7d)"
