...
const planPath = resolve(repoRoot, "output/convenience-store-audio-plan/manifest.json");
const generatedPath = resolve(
  repoRoot,
  "output/convenience-store-audio-candidates/generated-manifest.json",
);
const audioRoot = resolve(repoRoot, "output/convenience-store-audio-candidates");
...
if (plan.series !== "convenience-store" || manifest.series !== "convenience-store") {
  issues.push("plan and generated manifest must both identify convenience-store");
}
